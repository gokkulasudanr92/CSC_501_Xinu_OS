...
Please download and untar a fresh version of the XINU for QEMU source at (csc501-lab2-qemu.tgz). We have ported XINU to QEMU for better performance and easier debug support. You should NOT use the modified XINU source in which you implemented your PA1 schedulers. Read the instruction here to learn how to run XINU with QEMU on VCL.
