...
int debuging_enabled = 0;
sc_circular_queue *sc_head = NULL;
sc_circular_queue *sc_current = NULL;
aging_queue *aging_head = NULL;
...
*/
	...
	//Initialize Backstore Map
	init_bsm();
	//Initialize Frame Map
	init_frm();
	
	//Set the Page Fault Interrupt Service Routine
	set_evec(14, pfintr);
	
	// Initialize Global Page Table
	initialize_global();
	
	// Initialize Page Directory for the NULLPROC
	init_page_directory_NULLPROC();
	
	// Write the PDBR of NULLPROC to CR3 Register
